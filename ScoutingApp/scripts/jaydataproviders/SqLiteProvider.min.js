...
length:{},forEach:{},toArray:{},single:{},take:{},skip:{},orderBy:{},orderByDescending:{},first:{},include:{}},enumerable:!0,writable:!0},buildDbType_modifyInstanceDefinition:function(a,b){var c=function(b,d){var c;d?(c=JSON.parse(JSON.stringify(a[d])),c.kind=b.kind,c.name=b.name,c.notMapped=!1):c=JSON.parse(JSON.stringify(b));c.dataType=Container.resolveType(b.dataType);c.type=c.dataType;c.key=!1;c.computed=!1;return c},d=function(a,b,c,d){var i={};i[a.name]=c;i[b.name]=d+"__"+c;return i};b.Associations&&
b.Associations.forEach(function(b){var f=!1,g=b.FromType,h=b.ToType,i=b.ToPropertyName;b.ReferentialConstraint=b.ReferentialConstraint||[];if("*"==b.FromMultiplicity&&"0..1"==b.ToMultiplicity||"0..1"==b.FromMultiplicity&&"1"==b.ToMultiplicity)g=b.ToType,h=b.FromType,i=b.FromPropertyName,f=!0;g.memberDefinitions.getPublicMappedProperties().filter(function(a){return a.key}).forEach(function(j){f&&(a[i+"__"+j.name]=c(j,i));b.ReferentialConstraint.push(d(g,h,j.name,i))},this)},this);b.ComplexTypes&&b.ComplexTypes.forEach(function(b){b.ReferentialConstraint=
b.ReferentialConstraint||[];b.ToType.memberDefinitions.getPublicMappedProperties().forEach(function(f){a[b.FromPropertyName+"__"+f.name]=c(f);b.ReferentialConstraint.push(d(b.ToType,b.FromType,f.name,b.FromPropertyName))},this)},this)},buildDbType_generateConvertToFunction:function(a){return function(b){var c=new a.PhysicalType;c.entityState=b.entityState;a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){c[a.name]=b[a.name]},this);a.Associations&&a.Associations.forEach(function(a){if("*"==
a.FromMultiplicity&&"0..1"==a.ToMultiplicity||"0..1"==a.FromMultiplicity&&"1"==a.ToMultiplicity){var e=b[a.FromPropertyName];void 0!==e&&a.ReferentialConstraint.forEach(function(b){c[b[a.From]]=null!==e?e[b[a.To]]:null},this)}},this);a.ComplexTypes&&a.ComplexTypes.forEach(function(a){var e=b[a.FromPropertyName];void 0!==e&&a.ReferentialConstraint.forEach(function(b){c[b[a.From]]=null!==e?e[b[a.To]]:null},this)},this);return c}},initializeStore:function(a){a=$data.typeSystem.createCallbackSetting(a);
this.context._storageModel.forEach(function(a){this.SqlCommands.push(this.createSqlFromStorageModel(a)+" ")},this);var b=this._createSqlConnection(),c=this;b.createCommand("SELECT * FROM sqlite_master WHERE type = 'table'",null).executeQuery({success:function(d){for(var e={},f=0;f<d.rows.length;f++){var g=d.rows[f];e[g.tbl_name]=g}switch(c.providerConfiguration.dbCreation){case $data.storageProviders.DbCreationType.Merge:Guard.raise(new Exception("Not supported db creation type"));break;case $data.storageProviders.DbCreationType.DropTableIfChanged:d=
[];for(f=0;f<c.SqlCommands.length;f++)if(""!=c.SqlCommands[f]){var h=/^CREATE TABLE IF NOT EXISTS ([^ ]*) (\(.*\))/g.exec(c.SqlCommands[f]);if(h&&(g=h[1],h=h[2],e[g.slice(1,g.length-1)])){var i=/^CREATE TABLE ([^ ]*) (\(.*\))/g.exec(e[g.slice(1,g.length-1)].sql)[2];h.toLowerCase()!=i.toLowerCase()&&d.push("DROP TABLE IF EXISTS ["+e[g.slice(1,g.length-1)].tbl_name+"];")}}c.SqlCommands=c.SqlCommands.concat(d);break;case $data.storageProviders.DbCreationType.DropAllExistingTables:for(h in e)h&&!h.match("^__")&&
!h.match("^sqlite_")&&c.SqlCommands.push("DROP TABLE IF EXISTS ["+e[h].tbl_name+"];")}c._runSqlCommands(b,{success:a.success,error:a.error})},error:a.error})},executeQuery:function(a,b){var b=$data.typeSystem.createCallbackSetting(b),c=this._createSqlConnection(),d=this._compile(a);a.actionPack=d.actions;a.sqlConvertMetadata=d.converter;a.modelBinderConfig=d.modelBinderConfig;c.createCommand(d.sqlText,d.params).executeQuery({success:function(c){b.success&&(a.rawDataList=c.rows,b.success(a))},error:b.error})},
_compile:function(a){var b=new $data.storageProviders.sqLite.SQLiteCompiler,a=b.compile(a);a.hasSelect=null!=b.select;return a},getTraceString:function(a){return this._compile(a)},_runSqlCommands:function(a,b){if(this.SqlCommands&&0<this.SqlCommands.length){var c=this.SqlCommands.pop(),d=this;a.createCommand(c,null).executeQuery({success:function(){d._runSqlCommands.apply(d,[a,b])},error:b.error})}else b.success(this.context)},setContext:function(a){this.context=a},saveChanges:function(a,b){var c=
this._createSqlConnection(),d=this.buildIndependentBlocks(b);this.saveIndependentBlocks(b,d,c,a)},saveIndependentBlocks:function(a,b,c,d){function e(){if(0===g.length)d.success();else{var a=g.shift().map(function(a){var b=f.context._storageModel.getStorageModel(a.data.getType()).PhysicalType;a.physicalData=b.convertTo(a.data);return a},this);f.saveIndependentItems(a,c,{success:function(){f.postProcessItems(a);e()},error:d.error})}}var f=this,g=[].concat(b);e()},saveIndependentItems:function(a,b,c){function d(a,
b){var c=[],d=[];b.forEach(function(a,b){if(a&&(a.query&&(c[b]=a.query),a.param))d[b]=a.param});return a.createCommand(c,d)}var e=this,f=a.map(function(a){return e.saveEntitySet(a)}),f=f.filter(function(a){return a});0===f.length?c.success(a):d(b,f).executeQuery({success:function(f){f=f.map(function(c,d){return c&&c.insertId?e.save_reloadSavedEntity(c.insertId,a[d].entitySet.tableName,b):null});f=d(b,f);0<f.query.length?f.executeQuery(function(b){b.forEach(function(b,c){b&&b.rows&&(a[c].physicalData.initData=
...
case $data.EntityState.Deleted:return this.save_DeleteEntity(a);case $data.EntityState.Modified:return this.save_UpdateEntity(a);case $data.EntityState.Unchanged:break;default:Guard.raise(new Exception("Not supported entity state"))}},save_DeleteEntity:function(a){for(var b="DELETE FROM ["+a.entitySet.name+"] WHERE(",c=!1,d=!1,e=[];!c;)a.physicalData.constructor.memberDefinitions.getPublicMappedProperties().forEach(function(f){c&&!b.match(" AND $")&&(b+=" AND ");if(f.key||d)b+="(["+f.name+"] == ?)",
e.push(this.fieldConverter.toDb[Container.resolveName(f.dataType)](a.data[f.name])),c=!0},this),c||(d=!0);b.match(" AND $")&&(b=b.slice(0,b.length-5));b+=");";return{query:b,param:e}},save_UpdateEntity:function(a){var b=" SET ",c="WHERE(",d=!1,e=[],f=[];a.physicalData.constructor.memberDefinitions.getPublicMappedProperties().forEach(function(g){void 0!==a.physicalData[g.name]&&(d&&!c.match(" AND $")&&(c+=" AND "),5<b.length&&!b.match(",$")&&(b+=","),g.key?(c+="(["+g.name+"] == ?)",e.push(this.fieldConverter.toDb[Container.resolveName(g.dataType)](a.physicalData[g.name])),
d=!0):(b+="["+g.name+"] = ?",f.push(this.fieldConverter.toDb[Container.resolveName(g.dataType)](a.physicalData[g.name]))))},this);d||Guard.raise(new Exception("Not supported UPDATE function without primary key!"));c.match(" AND $")&&(c=c.slice(0,c.length-5));b.match(",$")&&(b=b.slice(0,b.length-1));return{query:"UPDATE ["+a.entitySet.tableName+"]"+b+" "+c+");",param:f.concat(e)}},save_NewEntity:function(a){var b="INSERT INTO ["+a.entitySet.tableName+"](",c="",d="",e=[];a.physicalData.constructor.memberDefinitions.getPublicMappedProperties().forEach(function(b){0<
c.length&&","!=c[c.length-1]&&(c+=",",d+=",");var g=b.name;if(void 0!==a.physicalData[g]&&b.dataType&&(!b.dataType.isAssignableTo||b.dataType.isAssignableTo&&!b.dataType.isAssignableTo($data.EntitySet)))d+="?",c+="["+g+"]",e.push(this.fieldConverter.toDb[Container.resolveName(b.dataType)](a.physicalData[g]))},this);1>e.length&&Guard.raise(new Exception("None of the fields contain values in the entity to be saved."));","==c[c.length-1]&&(c=c.slice(0,c.length-1));","==d[d.length-1]&&(d=d.slice(0,d.length-
1));return{query:b+(c+") VALUES("+d+");"),param:e}},save_reloadSavedEntity:function(a,b){return{query:"SELECT * FROM "+b+" WHERE rowid=?",param:[a]}},createSqlFromStorageModel:function(a){(void 0===a||null===a||void 0===a.PhysicalType)&&Guard.raise("StorageModel not contains physical entity definition");var b=0,c=0;a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){a.key&&b++;a.computed&&c++},this);1===c&&1<b&&Guard.raise(new Exception("Do not use computed field with multiple primary key!"));
1<c&&1<b&&Guard.raise(new Exception("Do not use multiple computed field!"));var d="CREATE TABLE IF NOT EXISTS ["+a.TableName+"] (",e=",PRIMARY KEY (";a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(b,g){0<g&&!d.match(", $")&&!d.match("\\($")&&(d+=", ");d+=this.createSqlFragmentFromField(b,1===c,a);0===c&&b.key&&(14<e.length&&!e.match(", $")&&(e+=", "),e+="["+b.name+"]")},this);d.match(", $")&&(d=d.substr(0,d.length-2));0===c&&14<e.length&&(d+=e+")");return d+=");"},createSqlFragmentFromField:function(a,
b,c){return"schemaCreate"in a&&a.schemaCreate?a.schemaCreate(a):(new this.FieldTypeBuilder(a,this,b,c)).build()},FieldTypeBuilder:function(a,b,c,d){this.fieldDef="";this.fld=a;this.provider=b;this.parsePk=c;this.entitySet=d;this.build=function(){switch(Container.resolveType(this.fld.dataType)){case $data.String:case $data.Guid:case "text":case "string":this.buildFieldNameAndType("TEXT");break;case $data.Boolean:case $data.Integer:case "bool":case "boolean":case "int":case "integer":this.buildFieldNameAndType("INTEGER");
break;case $data.Number:case $data.Date:case "number":case "datetime":case "date":this.buildFieldNameAndType("REAL");break;case $data.Blob:case "blob":this.buildFieldNameAndType("BLOB");break;default:this.buildRelations()}return this.fieldDef};this.buildFieldNameAndType=function(a){this.fieldDef="["+this.fld.name+"] "+a;this.parsePk?this.buildPrimaryKey():this.buildNotNull()};this.buildPrimaryKey=function(){this.fld.key?(this.fieldDef+=" PRIMARY KEY",this.buildAutoIncrement()):this.buildNotNull()};
this.buildNotNull=function(){this.fld.required&&(this.fieldDef+=" NOT NULL")};this.buildAutoIncrement=function(){this.fld.computed&&(this.fieldDef+=" AUTOINCREMENT")}}},{isSupported:{get:function(){return"openDatabase"in window},set:function(){}}});
...
this.hasProjection=true;b.addText(SqlStatementBlocks.select);Container.createSqlProjectionCompiler().Visit(a,b)},VisitEntitySetExpression:function(a,b){b.selectTextPart("from");b.addText(SqlStatementBlocks.from);b.sets.forEach(function(a,d){d>0&&b.addText(" \n\tLEFT OUTER JOIN ");var e=b.getExpressionAlias(a);b.addText(a.instance.tableName+" ");b.addText(e);if(d>0){b.addText(" ON (");var f=this.infos[d],g="T"+f.AliasNumber,h=f.NavigationPath.substring(0,f.NavigationPath.lastIndexOf(".")),e=this.infos.filter(function(a){return a.NavigationPath==
h},this),i="T0";e.length>0&&(i="T"+e[0].AliasNumber);f.Association.associationInfo.ReferentialConstraint.forEach(function(a){b.addText(i+"."+a[f.Association.associationInfo.From]);b.addText(" = ");b.addText(g+"."+a[f.Association.associationInfo.To])},this);b.addText(")")}},this)},VisitDefaultProjection:function(a){a.selectTextPart("projection");var b=this.infos.filter(function(a){return a.IsMapped}).length>1;if(a.sets.length>1){a.addText(SqlStatementBlocks.select);a.sets.forEach(function(c,d){if(this.infos[d].IsMapped){var e=
a.getExpressionAlias(c);c.storageModel.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(c,g){(g>0||d>0)&&a.addText(SqlStatementBlocks.valueSeparator);a.addText(e+".");a.addText(c.name);if(b){a.addText(SqlStatementBlocks.as);a.addText(e+"__"+c.name)}},this)}},this)}else a.addText("SELECT *")}});$data.Expressions.ExpressionNode.prototype.monitor=function(a,b){return Container.createExpressionMonitor(a).Visit(this,b)};
...
this.path},this);if(c.length>0)return b.sets[c[0].AliasNumber];(c=this.backupContextExpression.instance.getType().memberDefinitions.getMember(a.storageModel.EntitySetReference.name))||Guard.raise("Context schema error");c=Container.createMemberInfoExpression(c);c=Container.createEntitySetExpression(this.backupContextExpression,c);c.instance=this.backupContextExpression.instance[a.storageModel.EntitySetReference.name];var d=b.sets.push(c);b.infos.push({AliasNumber:d-1,Association:a.selector,NavigationPath:this.path,
IsMapped:this.isMapped});return c}},b),d=Container.createSqlCompiler(c,b);d.compile();Container.createSqlBuilder(this.sets,this.entityContext);a.modelBinderConfig={};Container.createsqLite_ModelBinderCompiler(a,b).Visit(c);return{sqlText:d.filters[0].selectedFragment.text,params:d.filters[0].selectedFragment.params,modelBinderConfig:a.modelBinderConfig}}},null);
...
d=c.mapTo||c.name;b.addText(d);b.addText(SqlStatementBlocks.beginGroup);if(d==="like"){d=Container.createSqlBuilder();this.Visit(a.parameters[0],d);d.params.forEach(function(a){var d=c.parameters[0],a=d.prefix?d.prefix+a:a,a=d.suffix?a+d.suffix:a;b.addParameter(a)});b.addText(d.sql);b.addText(" , ");this.Visit(a.source,b)}else{this.Visit(a.source,b);a.parameters.forEach(function(a){b.addText(" , ");this.Visit(a,b)},this)}b.addText(SqlStatementBlocks.endGroup)},VisitUnaryExpression:function(a,b){b.addText(a.resolution.mapTo);
...
var g=Container.createConstantExpression(a);c.Visit(g,b)});b.addText(SqlStatementBlocks.endGroup)}else d instanceof $data.Queryable?Guard.raise("not yet... but coming"):Guard.raise(new Exception("Only constant arrays and Queryables can be on the right side of 'in' operator","UnsupportedType"))}else this.Visit(a.right,b);b.addText(SqlStatementBlocks.endGroup)},VisitConstantExpression:function(a,b){b.addParameter(a.value);b.addText(SqlStatementBlocks.parameter)},VisitEntityFieldExpression:function(a,
b){if(a.source instanceof $data.Expressions.ComplexTypeExpression){var c=b.getExpressionAlias(a.source.source.source),d=a.source.source.storageModel.ComplexTypes[a.source.selector.memberName],e=d.ReferentialConstraint.filter(function(b){return b[a.source.selector.memberName]==a.selector.memberName})[0];if(e){b.addText(c);b.addText(SqlStatementBlocks.nameSeparator);b.addText(e[d.From])}else Guard.raise(new Exception("Compiler error! ComplexType does not contain "+a.source.selector.memberName+" property!"))}else{this.Visit(a.source,
...
b.addText(this.anonymFiledPrefix+a[d.To])},this)},VisitMemberInfoExpression:function(a,b){b.addText(a.memberName)},VisitObjectLiteralExpression:function(a,b){for(var c=a.members.length,d=0;d<c;d++){d!=0&&b.addText(SqlStatementBlocks.valueSeparator);this.Visit(a.members[d],b)}},MappedFullEntitySet:function(a,b){var c=b.getExpressionAlias(a);a.storageModel.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a,e){if(!a.association){e>0&&b.addText(SqlStatementBlocks.valueSeparator);
b.addText(c);b.addText(SqlStatementBlocks.nameSeparator);b.addText(a.name);b.addText(SqlStatementBlocks.as);b.addText(this.anonymFiledPrefix+a.name)}},this)},VisitObjectFieldExpression:function(a,b){var c=this.currentObjectLiteralName;this.currentObjectLiteralName=this.currentObjectLiteralName?this.currentObjectLiteralName+("."+a.fieldName):a.fieldName;if(a.expression instanceof $data.Expressions.EntityExpression)this.VisitEntityExpressionAsProjection(a,b);else{var d=this.anonymFiledPrefix;this.anonymFiledPrefix=
this.anonymFiledPrefix+(a.fieldName+"__");a.expression instanceof $data.Expressions.EntitySetExpression?this.MappedFullEntitySet(a.expression,b):this.Visit(a.expression,b);this.anonymFiledPrefix=d;if(!(a.expression instanceof $data.Expressions.ObjectLiteralExpression)&&!(a.expression instanceof $data.Expressions.ComplexTypeExpression)&&!(a.expression instanceof $data.Expressions.EntitySetExpression)){b.addText(SqlStatementBlocks.as);b.addText(this.anonymFiledPrefix+a.fieldName)}}this.currentObjectLiteralName=
c}},null);
...
e="Monitor"+g;e in a&&a[e].apply(a,f);a.MutateExpressionNode&&a.MutateExpressionNode.apply(a,f);e="Mutate"+g;e in a&&(d=a[e].apply(a,f))}return d};this.VisitIncludeExpression=function(b,c){var d=this.Visit(b.source,c);a.isMapped=true;var e=this.Visit(b.selector,c);a.isMapped=false;return d!==b.source||e!==b.selector?Container.createIncludeExpression(d,e):b};this.VisitProjectionExpression=function(b,c){var d=this.Visit(b.source,c);a.isMapped=true;var e=this.Visit(b.selector,c);a.isMapped=false;if(d!==
b.source||e!==b.selector){d=Container.createProjectionExpression(d,e,b.params,b.instance);d.projectionAs=b.projectionAs;return d}return b}}});
...
this._sqlBuilder.getExpressionAlias(this.sqlContext.sets[0]);this._addPropertyToModelBinderConfig(this._query.defaultType,a);this.sqlContext.infos.forEach(function(b,c){if(c>0&&b.IsMapped){var d=b.NavigationPath.split(".");d.shift();d.forEach(function(e,g){if(e)if(a.modelBinderConfig[e])a.selectModelBinderProperty(e);else{a.selectModelBinderProperty(e);var h=false;if(b.Association.associationInfo.ToMultiplicity==="*"&&d.length-1===g){a.modelBinderConfig.$type=$data.Array;a.selectModelBinderProperty("$item");
